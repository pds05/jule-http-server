...
import ru.otus.java.basic.http.server.HttpRequestException;
...
public class CreateNewItemProcessor implements RequestProcessor {
    ...
    public void execute(HttpRequest request, OutputStream out) throws IOException {
        try {
            ...
            throw new HttpRequestException(HttpURLConnection.HTTP_BAD_REQUEST, "Некорректный формат входящего JSON объекта");
        }
    }
}
